...
namespace NorthOps.Portal.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult ApplicationStatusGridViewPartialAddNew(NorthOps.Portal.Models.ApplicantStatusModel item)
        {
        ...
        [HttpPost, ValidateInput(false)]
        public ActionResult ApplicationStatusGridViewPartialUpdate(NorthOps.Portal.Models.ApplicantStatusModel item)
        {
            var model = new object[0];
            if (ModelState.IsValid)
            {
